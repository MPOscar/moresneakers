...
var CollectionCreatorComponent = /** @class */ (function () {
    ...
    CollectionCreatorComponent.prototype.linkShopsModal = function () {
        var _this = this;
        this.modalRef = this.dialog.open(_ms_shops_components_link_shops_collection_link_shops_collection_modal_component__WEBPACK_IMPORTED_MODULE_13__["LinkShopsCollentionModalComponent"], {
            height: '90%',
            width: '90%',
            data: {
        ...
        this.modalRef.afterClosed().subscribe(function () {
            _this.changeCollection(_this.selectedCollection.value, _this.selectedBrand.value);
        });
    };
    CollectionCreatorComponent.prototype.linkOffersModal = function () {
        this.modalRef = this.dialog.open(_ms_offers_components_link_offers_collection_link_offers_collection_modal_component__WEBPACK_IMPORTED_MODULE_12__["LinkOffersCollentionModalComponent"], {
            height: '90%',
            width: '90%',
            data: {
                collectionId: this.collectionId,
    ...
    CollectionCreatorComponent.prototype.changeCollection = function (collectionId, brandId) {
        var _this = this;
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_ms_releases_components_releases_collection_table_releases_collection_table_component__WEBPACK_IMPORTED_MODULE_11__["ReleasesCollectionTableComponent"]),
        __metadata("design:type", _ms_releases_components_releases_collection_table_releases_collection_table_component__WEBPACK_IMPORTED_MODULE_11__["ReleasesCollectionTableComponent"])
