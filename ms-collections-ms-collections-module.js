...
var CollectionCreatorComponent = /** @class */ (function () {
    ...
    CollectionCreatorComponent.prototype.linkShopsModal = function () {
        var _this = this;
        this.modalRef = this.dialog.open(_ms_shops_components_link_shops_collection_link_shops_collection_modal_component__WEBPACK_IMPORTED_MODULE_12__["LinkShopsCollentionModalComponent"], {
            height: '90%',
            width: '90%',
            data: {
    ...
    CollectionCreatorComponent.prototype.linkOffersModal = function () {
        this.modalRef = this.dialog.open(_ms_offers_components_link_offers_collection_link_offers_collection_modal_component__WEBPACK_IMPORTED_MODULE_11__["LinkOffersCollentionModalComponent"], {
            height: '90%',
            width: '90%',
            data: {
                collectionId: this.collectionId,
