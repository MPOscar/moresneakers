...
var titleKey = 'Title Delete Task';
var deleteBtnKey = 'Delete Task';
var messageKey = 'Delete Task Message';
var errorKey = 'Error';
var deletedTaskMessageKey = 'Deleted Task Message';
    ...
    DeleteTaskComponent.prototype.deleteTask = function () {
        ...
        this.tasksService.deleteTask(this.data.id).subscribe(function (response) {
            _this.tasksService.reloadTasks().subscribe(function (response) {
                ...
                _this.toastr.success(deletedTaskMessageKey);
                _this.close();
            }, function (error) { return _this.errorHandlingService.handleUiError(errorKey, error); });
        }, function (error) {
...
module.exports = ":host {\n  display: flex;\n  flex-grow: 1;\n  flex-direction: column;\n  height: 100%; }\n\n.mat-dialog-container {\n  padding: 10px; }\n\n.mat-dialog-content {\n  height: 60%;\n  max-height: 82vh;\n  margin-bottom: 10px; }\n\n.mat-dialog-actions {\n  padding: 10px 0; }\n\nmat-card {\n  padding: 0px;\n  align-self: flex-start;\n  height: 200px;\n  width: 150px;\n  margin-left: 2px;\n  margin-right: 15px;\n  margin-bottom: 15px; }\n\nmat-icon {\n  font-size: 24px;\n  width: 24px;\n  height: 24px; }\n\n.max-width-60-pct {\n  max-width: 60% !important; }\n\n.border {\n  border: 1px solid #f1f1f1; }\n\ntd.mat-cell {\n  border: none !important; }\n\nth.mat-header-cell {\n  border: none !important; }\n\n::ng-deep .mat-dialog-container {\n  padding-right: 0px !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var errorKey = 'Error';
var updatedStyleMessageKey = 'Updated';
var EditTaskComponent = /** @class */ (function () {
    ...
    EditTaskComponent.prototype.updateStyle = function (data) {
        ...
        this.tasksService.putTask(data).subscribe(function (response) {
            ...
            _this.close();
            _this.toastr.success(updatedStyleMessageKey);
        }, function (error) {
            _this.errorHandlingService.handleUiError(errorKey, error);
...
module.exports = ":host {\n  display: flex;\n  flex-grow: 1;\n  flex-direction: column;\n  height: 100%; }\n\n.mat-dialog-container {\n  padding: 10px; }\n\n.mat-dialog-content {\n  height: 60%;\n  max-height: 82vh;\n  margin-bottom: 10px; }\n\n.mat-dialog-actions {\n  padding: 10px 0; }\n\nmat-card {\n  padding: 0px;\n  align-self: flex-start;\n  height: 200px;\n  width: 150px;\n  margin-left: 2px;\n  margin-right: 15px;\n  margin-bottom: 15px; }\n\nmat-icon {\n  font-size: 24px;\n  width: 24px;\n  height: 24px; }\n\n.max-width-60-pct {\n  max-width: 60% !important; }\n\n.border {\n  border: 1px solid #f1f1f1; }\n\ntd.mat-cell {\n  border: none !important; }\n\nth.mat-header-cell {\n  border: none !important; }\n\n::ng-deep .mat-dialog-container {\n  padding-right: 0px !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var titleKey = 'Title Delete Task';
var deleteBtnKey = 'Delete Task';
var messageKey = 'Delete Task';
var errorKey = 'Error';
var deletedTaskMessageKey = 'Deleted Task';
