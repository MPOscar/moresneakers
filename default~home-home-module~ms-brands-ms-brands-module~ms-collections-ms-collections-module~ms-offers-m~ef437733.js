...
module.exports = "    <div class=\"flex-shrink-0 display-flex justify-content-end close-mat-dialog-buttom\">\n        <span class=\"mat-button-wrapper cursor-pointer\" (click)=\"close()\">\n        <mat-icon>clear</mat-icon>\n        </span>\n    </div>\n    \n<h1 class=\"margin-top-0px\">OFFER CREATOR</h1>\n\n<offer-form class=\"flex-grow-1\"\n    [data]=\"data\"  \n    [shopId]=\"dialogData.shopId\"\n    [customized]=\"dialogData.customized\"\n    [shops]=\"dialogData.shops\" \n    [releases]=\"dialogData.releases\"  \n    [releaseId]=\"dialogData.releaseId\"     \n    (accept)=\"submit($event)\"\n    (cancel)=\"cancel()\"\n    [validationErrors]=\"validationErrors\"\n    (dataChange)=\"dataChanged()\">\n</offer-form>"
...
module.exports = ":host {\n  display: flex;\n  flex-grow: 1;\n  flex-direction: column;\n  height: 99%; }\n\n.mat-dialog-content {\n  height: 100%;\n  max-height: 82vh;\n  margin-bottom: 10px; }\n\n.mat-dialog-actions {\n  padding: 10px 0; }\n\n::ng-deep .mat-dialog-container {\n  padding: 0px 25px 25px 25px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
        ...
        if (this.formGroup.valid) {
            ...
            if (this.links) {
                this.links.forEach(function (element) {
                    delete element.id;
                    _this.data.links = _this.data.links.concat([element]);
                });
            }
...
var OffersNewReleaseTableComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], OffersNewReleaseTableComponent.prototype, "collectionNameForOffers", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], OffersNewReleaseTableComponent.prototype, "releaseDateForOffers", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], OffersNewReleaseTableComponent.prototype, "skuForOfers", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], OffersNewReleaseTableComponent.prototype, "colorsForOfers", void 0);
...
module.exports = ":host {\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1; }\n\ntable {\n  width: 100%; }\n\n.mat-form-field {\n  font-size: 14px;\n  padding-right: 5px;\n  width: 100px !important; }\n\ntd,\nth {\n  width: 25%; }\n\n.padding-bottom-10 {\n  padding-bottom: 10px; }\n\nimg {\n  height: 60px !important;\n  width: 100px !important; }\n\n::ng-deep mat-paginator {\n  padding-top: 2px !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ":host {\n  display: flex;\n  flex-grow: 1;\n  flex-direction: column;\n  height: 100%; }\n\n.mat-dialog-container {\n  padding: 10px; }\n\n.mat-dialog-content {\n  height: 60%;\n  max-height: 82vh;\n  margin-bottom: 10px; }\n\n.mat-dialog-actions {\n  padding: 10px 0; }\n\nmat-card {\n  padding: 0px;\n  align-self: flex-start;\n  height: 200px;\n  width: 150px;\n  margin-left: 2px;\n  margin-right: 15px;\n  margin-bottom: 15px; }\n\nmat-icon {\n  font-size: 24px;\n  width: 24px;\n  height: 24px; }\n\n.max-width-60-pct {\n  max-width: 60% !important; }\n\n.border {\n  border: 1px solid #f1f1f1; }\n\ntd.mat-cell {\n  border: none !important; }\n\nth.mat-header-cell {\n  border: none !important; }\n\nimg {\n  height: 150px !important;\n  width: 150px !important; }\n\n::ng-deep .mat-dialog-container {\n  padding: 0px 25px 25px 25px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
